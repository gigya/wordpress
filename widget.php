  ...
  function form($instance) {
    ...
    <p>
      <label for="<?php echo $this->get_field_id('header_text'); ?>"><?php _e('Header Text:'); ?>
        <input class="widefat" id="<?php echo $this->get_field_id('header_text'); ?>"
               name="<?php echo $this->get_field_name('header_text'); ?>" type="text"
               value="<?php echo $header_text; ?>"/>
      </label>
    </p>
    <p>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('button_size'); ?>"><?php _e('Button Size:'); ?>
        <input class="widefat" id="<?php echo $this->get_field_id('button_size'); ?>"
               name="<?php echo $this->get_field_name('button_size'); ?>" type="text"
               value="<?php echo $button_size; ?>"/>
      </label>
    </p>
    <p>
      <label for="<?php echo $this->get_field_id('enabledProviders'); ?>"><?php _e('Enabled Providers:'); ?>
        <input class="widefat" id="<?php echo $this->get_field_id('enabledProviders'); ?>"
               name="<?php echo $this->get_field_name('enabledProviders'); ?>" type="text"
               value="<?php echo $enabledProviders; ?>"/>
      </label>
    </p>
    <p>
      <label for="<?php echo $this->get_field_id('bgColor'); ?>"><?php _e('Background Color (#FFFFFF): '); ?> <br/>
        <input class="widefat" id="<?php echo $this->get_field_id('bgColor'); ?>"
               name="<?php echo $this->get_field_name('bgColor'); ?>" type="text" value="<?php echo $bgColor; ?>"/>
      </label>
    </p>
  <?php
  }
  ...
  function form($instance) {
      ...
      <label for="<?php echo $this->get_field_id('initial_tab'); ?>"><?php _e('Initial Tab:'); ?>
        <select class="widefat" id="<?php echo $this->get_field_id('initial_tab'); ?>"
          ...
          <option <?php if ($initial_tab == "everyone")
            echo "selected='true'" ?> value="everyone">Everyone
          </option>
          <option <?php if ($initial_tab == "friends")
            echo "selected='true'" ?> value="friends">Friends
          </option>
          <option <?php if ($initial_tab == "me")
            echo "selected='true'" ?> value="me">Me
          </option>
        </select>
      </label>
    </p>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('site_name'); ?>"><?php _e('Site Name:'); ?>
        <input class="widefat" id="<?php echo $this->get_field_id('site_name'); ?>"
               name="<?php echo $this->get_field_name('site_name'); ?>" type="text" value="<?php echo $site_name; ?>"/>
      </label>
    </p>
...
class WP_Widget_GigyaFollowBar extends WP_Widget {
  ...
  function form($instance) {
    ...
    if (empty($icon_size) || !is_numeric($icon_size))
      $icon_size = 32;
    if (empty($buttons))
      $buttons = get_followbar_default_buttons();
    ...
    <p>
      <label for="<?php echo $this->get_field_id('buttons'); ?>"><?php _e('Buttons:'); ?>
        <textarea style="width:100%;height:200px;" id="<?php echo $this->get_field_id('buttons'); ?>"
      ...
      <label for="<?php echo $this->get_field_id('layout'); ?>"><?php _e('Layout:'); ?>
        <select class="widefat" id="<?php echo $this->get_field_id('layout'); ?>"
          ...
          <option <?php if ($layout == "horizontal")
            echo "selected='true'" ?> value="horizontal">Horizontal
          </option>
          <option <?php if ($layout == "vertical")
            echo "selected='true'" ?> value="vertical">Vertical
          </option>
        </select>
      </label>
    </p>
    ...
    <p>
      <label for="<?php echo $this->get_field_id('iconSize'); ?>"><?php _e('Icon Size:'); ?>
        <input class="widefat" id="<?php echo $this->get_field_id('iconSize'); ?>"
               name="<?php echo $this->get_field_name('iconSize'); ?>" value="<?php echo $icon_size; ?>"/>
      </label>
    </p>
      ...
      <label for="<?php echo $this->get_field_id('type'); ?>"><?php _e('Type:'); ?>
        <select class="widefat" id="<?php echo $this->get_field_id('type'); ?>"
          ...
          <option <?php if ($type == "game")
            echo "selected='true'" ?> value="game">Game status
          </option>
          <option <?php if ($type == "challenge")
            echo "selected='true'" ?> value="challenge">Challenge Status
          </option>
          <option <?php if ($type == "leaderboard")
            echo "selected='true'" ?> value="leaderboard">Leaderboard
          </option>
          <option <?php if ($type == "achievements")
            echo "selected='true'" ?> value="achievements">Achievements
          </option>
        </select>
      </label>
    </p>
      ...
      <label for="<?php echo $this->get_field_id('period'); ?>"><?php _e('Time Period:'); ?>
        <select class="widefat" id="<?php echo $this->get_field_id('period'); ?>"
          ...
          <option <?php if ($period == "7")
            echo "selected='true'" ?> value="7">7 Days
          </option>
          <option <?php if ($period == "all")
            echo "selected='true'" ?> value="all">All
          </option>
        </select>
      </label>
    </p>

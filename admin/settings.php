...
<?php
	...
	function gigya_input_field($id = "",$label = "",$default = null,$desc = null) {
		...
		if($default && empty($value)) $value = $default;
	?>
		<div class="row">
			<div class="span3">
			...
			<div class="span6">
				<input type="text" class="input-xlarge" value="<?php echo $value;?>" id="gigya_<?php echo $id;?>" name="<?php echo GIGYA_SETTINGS_PREFIX ?>[<?php echo $id;?>]"/>
				<br/>
				<i><small><?php echo $desc;?></small></i>
			</div>
		</div>
	<?php
	};
	...
	?>
		<div class="row">
			...
			<div class="span6">
				<input type="checkbox" <?php echo ( $value || $value == "1" ? "checked='true'" : "");?> value="1" id="gigya_<?php echo $id;?>" name="<?php echo GIGYA_SETTINGS_PREFIX ?>[<?php echo $id;?>]"/>
				<?php if($desc): ?>
				<br/>
				<i><small><?php echo $desc;?></small></i>
				<?php endif;?>
	...
	?>
		<div class="row">
			...
			<div class="span6">
				<textarea class="large-text" id="gigya_<?php echo $id;?>" name="<?php echo GIGYA_SETTINGS_PREFIX ?>[<?php echo $id;?>]"><?php echo $value;?></textarea>
				<?php if($desc): ?>
				<br/>
				<i><small><?php echo $desc;?></small></i>
				<?php endif;?>
		...
		<div class="row">
			<div class="span3">
				<label for="gigya_<?php echo $id;?>">
					<?php _e($label); ?>
					<?php if($desc): ?>
					<i class="icon-question-sign" data-html="1" data-content="<?php echo esc_html($desc);?>" data-title="<?php echo $label;?>" rel="popover"></i>
					<?php endif;?>
				</label>
			</div>
			<div class="span6">
				<select id="gigya_<?php echo $id;?>" name="<?php echo GIGYA_SETTINGS_PREFIX ?>[<?php echo $id;?>]">
					...
					<option  <?php if($value == $option["v"]) echo "selected='true'";?> value="<?php echo $option["v"];?>"><?php echo $option["t"];?></option>
					<?php } ?>
				</select>
				<?php if($desc): ?>
				<br/>
	...
	if(empty($share_layout)) $short_url = "horizontal";
	...
	<form action="options.php" method="post">
		...
		<section id="login-section">
			...
			<div class="well">
				...
				<br/>
 				<i>The Plugin displays all the available providers' logos as login options, enabling the user to login to your site via his social network / webmail account.</i>
				<hr/>
				<!--  Button Style -->
				<?php 

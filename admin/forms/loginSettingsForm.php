...
function loginSettingsForm() {
	...
	$form['mode'] = array(
			...
			'options' => array(
					...
					'raas'    => __( 'Registration-as-a-Service Selecting this option overrides Drupal\'s user management system. This requires additional administration steps. Learn more </small><a href="http://developers.gigya.com/050_Partners/050_CMS_Modules/020_Drupal/Using_RaaS_with_Drupal">here</a><small>' )
			),
	...
	$form['advancedLoginUI'] = array(
			...
			'desc'  => __( 'Enter valid JSON format. See list of available' ) . ' <a href="http://developers.gigya.com/030_Gigya_Socialize_API_2.0/030_API_reference/010_Client_API_%28JavaScript%29/Social_service/Socialize.showLoginUI">' . __( 'parameters' ) . '</a>'
	);
	...
	$form['advancedAddConnectionsUI'] = array(
			...
			'desc'  => __( 'Enter valid JSON format. See list of available' ) . ' <a href="http://developers.gigya.com/020_Client_API/020_Methods/socialize.showAddConnectionsUI">' . __( 'parameters' ) . '</a>'
	);

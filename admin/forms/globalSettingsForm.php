...
function globalSettingsForm() {
	...
	$form['enabledProviders'] = array(
			...
			'desc'  => __( 'Comma separated list of providers to include. For example: facebook,twitter,google. Leave empty or type * for all providers. See the entire list of available' ) . ' <a href="https://developers.gigya.com/display/GD/socialize.showLoginUI+JS">Providers</a>'
	);

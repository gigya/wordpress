...
function gmSettingsForm() {
	...
	$form['advanced_achievements'] = array(
		...
		'desc'  => sprintf( __( 'Enter valid %s. See list of available:' ), '<a class="gigya-json-example" href="javascript:void(0)">' . __( 'JSON format' ) . '</a>' ) . ' <a href="http://developers.gigya.com/020_Client_API/040_GM/gm.showAchievementsUI" target="_blank" rel="noopener noreferrer">' . __( 'parameters' ) . '</a>'
	);
	...
	$form['advanced_challenge'] = array(
		...
		'desc'  => sprintf( __( 'Enter valid %s. See list of available:' ), '<a class="gigya-json-example" href="javascript:void(0)">' . __( 'JSON format' ) . '</a>' ) . ' <a href="http://developers.gigya.com/020_Client_API/040_GM/gm.showChallengeStatusUI" target="_blank" rel="noopener noreferrer">' . __( 'parameters' ) . '</a>'
	);
	...
	$form['advanced_leaderboard'] = array(
		...
		'desc'  => sprintf( __( 'Enter valid %s. See list of available:' ), '<a class="gigya-json-example" href="javascript:void(0)">' . __( 'JSON format' ) . '</a>' ) . ' <a href="http://developers.gigya.com/020_Client_API/040_GM/gm.showLeaderboardUI" target="_blank" rel="noopener noreferrer">' . __( 'parameters' ) . '</a>'
	);
	...
	$form['advanced_user_status'] = array(
		...
		'desc'  => sprintf( __( 'Enter valid %s. See list of available:' ), '<a class="gigya-json-example" href="javascript:void(0)">' . __( 'JSON format' ) . '</a>' ) . ' <a href="http://developers.gigya.com/020_Client_API/040_GM/gm.showUserStatusUI" target="_blank" rel="noopener noreferrer">' . __( 'parameters' ) . '</a>'
	);
	...
	$form['advanced_notification'] = array(
		...
		'desc'  => sprintf( __( 'Enter valid %s. See list of available:' ), '<a class="gigya-json-example" href="javascript:void(0)">' . __( 'JSON format' ) . '</a>' ) . ' <a href="http://developers.gigya.com/020_Client_API/040_GM/gm.showNotifications" target="_blank" rel="noopener noreferrer">' . __( 'parameters' ) . '</a>'
	);

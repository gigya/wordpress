...
<div class="wrap">
	...
	<div class="nav-tab-wrapper">
		<?php foreach ( $var['sections'] as $section ) : ?>
			<a href="?page=<?php echo $section['slug'] ?>"
			   class="nav-tab <?php echo ( isset( $var['page'] ) and $var['page'] == $section['slug'] ) ? 'nav-tab-active ' : '';
			   echo ( isset( $section['display'] ) and $section['display'] == 'hidden' ) ? 'hidden ' : ''; ?>"
			   id="tab-<?php echo $section['slug']; ?>"><?php echo $section['title'] ?></a>
		<?php endforeach; ?>
	</div>
	<?php

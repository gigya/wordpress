...
<div class="row text-field <?php echo (isset($class)) ? $class : ''; ?>">
	...
	<input type="text" size="<?php echo (isset($size)) ? (string)$size : '60'; ?>" class="<?php echo (isset($subclass)) ? $subclass : 'input-xlarge'; ?>" value="<?php echo $value; ?>" id="gigya_<?php echo $id; ?>" name="<?php echo $name ?>" />
	<?php
		if ( isset($markup) ):
			echo $markup;
		endif;

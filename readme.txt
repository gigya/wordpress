...
Increase your site registration and Engagement by integrating Gigyas social optimization service into your WordPress.
...
* Authenticate users via Social Networks and OpenID providers
...
New visitors can register to the site using the built-in Gigya login component. The site will create a WordPress user account in the database and connect the Social Network account to that user. 
Existing site users can link their existing Wordpress account to their Social Network account.

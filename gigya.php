...
function _gigya_add_to_wp_user_meta( $gigya_object, $user_id ) {
	...
	} else /* Legacy field mapping options */ { // @TODO: Might break because the options are in login_opts (GIGYA__SETTINGS_LOGIN) and not $field_mapping_opts ////
